...
<template>
  <div class="space-y-2">
    <div class="text-3xl text-gray-100 font-bold">Day 3</div>
      <p class="text-gray-200 text-xl">Go <a href="https://adventofcode.com/2022/day/3" class="text-blue-400 hover:underline">here</a> to check the description of the task.</p>

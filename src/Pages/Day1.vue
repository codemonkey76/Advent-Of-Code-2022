...
<template>
  <div class="space-y-2">
    ...
    <p class="text-gray-200 text-xl">Go <a href="https://adventofcode.com/2022/day/1" class="text-blue-400 hover:underline">here</a> to check the description of the task.</p>
